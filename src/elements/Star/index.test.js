...
test("should have props value,width,height,spacing", () => {
  ...
  const starActive = "div.stars div.star:not(.placeholder)";
  ...
  expect(container.querySelector(starActive)).toBeInTheDocument();
  expect(container.querySelector(starActive)).toHaveAttribute(
    "style",
